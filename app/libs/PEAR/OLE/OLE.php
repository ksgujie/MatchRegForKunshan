...
class OLE extends PEAR
{
    ...
    */
     ...
     * @access private
     */
    static function _getBlockOffset($blockId)
    {
     ...
     */
    static function getStream($blockIdOrPps)
    {
    ...
    * @return mixed true on success, PEAR_Error on failure
    */
    static function _readPpsWks($blockId)
    {
    ...
    */
    static function _ppsTreeComplete($index)
    {
    ...
    */
    static function getData($index, $position, $length)
    {
    ...
    * @access public
    */
    static function getDataLength($index)
    {
        if (isset($this->_list[$index])) {
    ...
    /**
    * Utility static function to transform ASCII text to Unicode
    *
    * @access public
    * @static
